...
public class UtilTablasMonitor {
    ...
    public UtilTablasMonitor(VistaMonitores vMonitor){
    ...
    public void dibujarTablaMonitores(VistaMonitores vMonitor){
        ...
        modeloTablaMonitores.setColumnIdentifiers(columnasTablas);
        ...
        vMonitor.jTableMonitores.getColumnModel().getColumn(1).setPreferredWidth(210);
